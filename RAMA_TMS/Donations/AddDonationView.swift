...
//                        .foregroundColor(RamaTheme.primary)
//
//                    Toggle("Organization", isOn: $isOrganization)
//                        .tint(RamaTheme.primary)
//
//                    if isOrganization {
//                        RamaTextField(title: "Organization Name", text: $organizationName)
//                    } else {
//                        HStack {
//                            RamaTextField(title: "First Name", text: $firstName)
//                            RamaTextField(title: "Last Name", text: $lastName)
//                        }
//                    }
//
//                    RamaTextField(title: "Phone", text: $phone, keyboard: .phonePad)
//                    RamaTextField(title: "Email", text: $email, keyboard: .emailAddress)
//
//                    RamaTextField(title: "Address Line 1", text: $address1)
//                    RamaTextField(title: "Address Line 2", text: $address2)
//                    HStack {
//                        RamaTextField(title: "City", text: $city)
//                        RamaTextField(title: "State", text: $stateText)
//                    }
//                    HStack {
//                        RamaTextField(title: "Country", text: $country)
//                        RamaTextField(title: "Postal Code", text: $postalCode)
//                    }
//                }
//                .padding()
//                .background(RamaTheme.card)
...
//                        .foregroundColor(RamaTheme.primary)
//
//                    RamaTextField(title: "Amount", text: $amount, keyboard: .decimalPad)
//
//                    Picker("Donation Type", selection: $donationType) {
//                        ForEach(donationTypes, id: \.self) { Text($0) }
//                    }
//                    .pickerStyle(.segmented)
//                    .tint(RamaTheme.primary)
//
...
//                        
//                        Picker("Payment Mode", selection: $paymentMode) {
//                            ForEach(paymentModes, id: \.self) { Text($0) }
//                        }
//                        .pickerStyle(.segmented)
//                        .onChange(of: paymentMode) { _, newValue in
//                            if newValue == "Zelle" {
...
//
//                    RamaTextField(
//                        title: isReferenceRequired ? "Reference No *" : "Reference No",
//                        text: $referenceNo
//                    )
//                    
//                    if isReferenceRequired && referenceNo.isEmpty {
//                        Text("Reference number is required for \(paymentMode)")
//                            .font(.caption)
//                            .foregroundColor(.red)
//                    }
//                    
//                    RamaTextField(title: "Notes", text: $notes)
//                }
//                .padding()
//                .background(RamaTheme.card)
//                .cornerRadius(12)
...
//                .frame(maxWidth: .infinity)
//                .padding()
//                .background(isFormValid ? RamaTheme.primary : Color.gray)
//                .foregroundColor(.white)
//                .cornerRadius(12)
//                .disabled(!isFormValid || isSubmitting)
//            }
//            .padding()
//            .background(RamaTheme.background.ignoresSafeArea())
//        }
//        .navigationTitle("Add Donation")
//        .sheet(isPresented: $showZelleQR) {
//            ZelleQRView()
//        }
//    }
//
...
//                    .shadow(radius: 4)
//                
//                Text("After payment, enter the reference number in the form")
//                    .font(.subheadline)
//                    .foregroundColor(.secondary)
//                    .multilineTextAlignment(.center)
//                    .padding(.horizontal, 32)
